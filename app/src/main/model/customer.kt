//
//class Customer (id: Int, accNum: Account, custName: String, custAddress: String, custPhone: String, custEmail: String, custPassword: String, custPict: String, verified: bool, channel: String, created Date, updated Date) {
//    val customerId = id
