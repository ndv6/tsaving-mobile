...
import com.example.tsaving.helpers.TransactionHistoryHelpers
...
class TransactionHistoryAdapter :
    ...
    class TransactionHistoryViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
        fun bindData(position: TransactionHistoryResponseData) {
            ...
            TransactionHistoryHelpers.setImgSrc(position.description, transactionHistoryIcon)
            tranAmt.text = position.transferAmount.currencyFormatter("IDR")
            TransactionHistoryHelpers.formatTransactionAmount(position.description, tranAmt)
